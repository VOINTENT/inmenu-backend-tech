...
class CoordsSchema(Schema):
    lat = fields.Integer(required=True, allow_none=True, error_messages={'required': ValidationErrorEnum.NOT_FIELD})
    long = fields.Integer(required=True, allow_none=True, error_messages={'required': ValidationErrorEnum.NOT_FIELD})
...
class PlaceAddSchema(Schema):
    ...
    locations = fields.List(fields.Nested(LocationsSchema), required=False, allow_none=True)
