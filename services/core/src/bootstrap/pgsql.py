from src.configs.pgsql import HOST, USER, PASSWORD, PORT, PRIMARY_DB_NAME, LOGS_DB_NAME
...
def init_pgsql_server():
    ...
    AsyncPg.init_logs_db(SanicServer.get_app(), HOST, USER, PASSWORD, PORT, LOGS_DB_NAME)
